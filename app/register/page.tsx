          ...
          <div className="md:max-w-md w-full px-4 py-4">
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-foreground text-[13px] font-medium block mb-2">First Name</label>
                  <div className="relative flex items-center">
                    <input
                      ...
                      placeholder="John"
                    />
                    <User className="w-[18px] h-[18px] absolute right-2 text-[#bbb]" />
                  </div>
                </div>
                <div>
                  <label className="text-foreground text-[13px] font-medium block mb-2">Last Name</label>
                  <div className="relative flex items-center">
                    <input
                      name="lastName"
                      type="text"
              ...
              <div className="mt-4">
                <label className="text-foreground text-[13px] font-medium block mb-2">Phone Number</label>
                <div className="relative flex items-center">
                  <input
                    name="phone"
                    type="tel"
                  ...
                  />
                  <Phone className="w-[18px] h-[18px] absolute right-2 text-[#bbb]" />
                </div>
              </div>

              {role === "teacher" && (
                <div className="mt-4">
                  <label className="text-foreground text-[13px] font-medium block mb-2">Institution</label>
                  <div className="relative flex items-center">
                    <input
                      name="institution"
                      type="text"
                    ...
                    />
                    <Building2 className="w-[18px] h-[18px] absolute right-2 text-[#bbb]" />
                  </div>
                </div>
              )}
              ...
              <div className="mt-4">
                <label className="text-foreground text-[13px] font-medium block mb-2">Confirm Password</label>
                <div className="relative flex items-center">
                  <input
