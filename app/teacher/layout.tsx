  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { href: "/teacher/library", label: "Online Library", Icon: Library },
      ],
    },
    {
      title: "Management",
      items: [
        { href: "/teacher/course-management", label: "Course Management", Icon: BookOpen },
        { href: "/teacher/assignments", label: "Assignments & Grading", Icon: ClipboardList },
        { href: "/teacher/attendance", label: "Attendance", Icon: CalendarDays },
        { href: "/teacher/grade-submission", label: "Grade Submission", Icon: FileText },
        { href: "/teacher/student-management", label: "Student Management", Icon: Users },
      ],
    },
    {
      title: "Schedule",
    ...
    },
    {
      title: "Profile",
      items: [
        { href: "/teacher/profile", label: "Profile", Icon: User2 },
      ],
    },
  ]
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  ...
                  <div className="text-xs text-muted-foreground">{user?.role || "teacher"}</div>
                </div>
              </button>
              {userMenuOpen && (
